...
class Config:
    def __init__(self):
        ...
        # Support Links
        self.SUPPORT_CHANNEL: str = getenv("SUPPORT_CHANNEL", "https://t.me/BOT420_UPDATE")
        self.SUPPORT_CHAT: str = getenv("SUPPORT_CHAT", "@yoi_420")
        ...
        # Music420bot API 
        self.MUSIC420BOT_API_URL: str = getenv("MUSIC420BOT_API_URL", "")
        self.MUSIC420BOT_KEY: str = getenv("MUSIC420BOT_KEY", "")
        ...
        # Images
        self.DEFAULT_THUMB: str = getenv("DEFAULT_THUMB", "https://ibb.co/67hz0XDY")
        self.PING_IMG: str = getenv("PING_IMG", "https://ibb.co/pjRKBwBh")
        self.START_IMG: str = getenv("START_IMG", "https://ibb.co/gZzbk0JS")
        self.RADIO_IMG: str = getenv("RADIO_IMG", "https://ibb.co/21gG4LJq")
    ...
    def check(self) -> None:
        ...
        if self.ENABLE_API and not self.MUSIC420BOT_KEY:
            print("Warning: ENABLE_API is True but MUSIC420BOT_KEY is not set")
